...
class SettingTab extends PluginSettingTab {
  ...
  async display() {
    ...
    cont.createEl("br");
    new Setting(cont).setName("\u4EE3\u7406\u670D\u52A1\u5668").setDesc("\u901A\u8FC7\u9009\u62E9\u4E0D\u540C\u7684\u670D\u52A1\u5668\u6765\u5207\u6362\u4EE3\u7406\uFF0C\u53EF\u4EE5\u89E3\u51B3\u67D0\u4E9B\u60C5\u51B5\u4E0B\uFF0C\u67D0\u4E2A\u670D\u52A1\u5668\u65E0\u6CD5\u8BBF\u95EE\u7684\u60C5\u51B5\u3002").addDropdown(async (dropDown) => {
    ...
    new Setting(cont).setName("\u81EA\u5B9A\u4E49\u4EE3\u7406\u670D\u52A1\u5668").setDesc("\u53EF\u4EE5\u5728\u63D2\u4EF6\u76EE\u5F55\u4E0B\u7684 data.json \u4E2D\u81EA\u5B9A\u4E49\u4EE3\u7406\u3002e.g. <project>/.obsidian/plugins/obsidian-plugin-proxy/data.json");
  }
}
